...
class RobotControl():
    ...
    def move_straight_time(self, motion, speed, input_time):
        ...
        s = "Moved robot " + motion + " for " + str(input_time) + " seconds"
        return s

    def turn(self, clockwise, speed, input_time):
        ...
        s = "Turned robot " + clockwise + " for " + str(input_time) + " seconds"
        return s
